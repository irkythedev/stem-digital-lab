...
export const CIRCUIT_STYLES: StyleConfig[] = [
  {
    ...
    kind: 'series',
    elements: [
      { kind: 'bulb', r: 10, label: 'L₁', x: 200 },
      { kind: 'bulb', r: 20, label: 'L₂', x: 260 },
    ],
  ...
  },
  {
    ...
    kind: 'series',
    elements: [
      { kind: 'bulb', r: 10, label: 'L₁', x: 175 },
      { kind: 'bulb', r: 20, label: 'L₂', x: 225 },
      { kind: 'bulb', r: 30, label: 'L₃', x: 275 },
    ],
    branchSwitches: false,
    fuse: false,
    fixedMeters: false,
  ...
  },
  {
    ...
    kind: 'parallel',
    elements: [
      { kind: 'bulb', r: 484, label: 'L₁', x: 200 },
      { kind: 'bulb', r: 968, label: 'L₂', x: 200 },
    ],
    branchSwitches: true,
    fuse: true,
    fixedMeters: false,
