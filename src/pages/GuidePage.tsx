...
const copy = {
  zh: {
    title: '使用说明',
    backHome: '返回',
    intro: '这是一个本地运行的初中 STEM 数字探究空间，不需要登录；反馈会发送给开发者，离线时自动暂存，联网后补发。',
    flow: '基本流程',
  ...
  en: {
    title: 'How to use',
    backHome: 'Back',
    intro: 'A local middle-school STEM exploration space. No login is needed; feedback is sent to the developer, or queued locally while offline and retried when back online.',
    flow: 'Basic flow',
