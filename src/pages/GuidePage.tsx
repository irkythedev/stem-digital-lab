...
const copy = {
  zh: {
    ...
    ai: 'AI 学习助手',
    aiIntro: '右下角 AI 学习助手可辅助解释数理化知识。您需自带 AI 服务商（仅限大陆可用）的 API Key，本站不提供、不代购、不收取任何费用。',
  ...
  en: {
    ...
    ai: 'AI Assistant',
    aiIntro: 'The AI assistant (bottom-right) helps explain math / physics / chemistry. You bring your own API key from a mainland-China provider; this site provides no key, sells nothing and charges nothing.',
